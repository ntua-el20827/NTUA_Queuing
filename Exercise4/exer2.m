...
while 1 > 0
  ...
  elseif current_state == 1
    if random_number < threshold_1a #αν εχω αφιξη
      current_state = 3;
      arrivals(2) = arrivals(2) + 1;
      total_arrivals = total_arrivals + 1;
    else #αν εχω αναχωρηση
      current_state = 0;
    endif
  elseif current_state == 2
    if random_number < threshold_1b #αν εχω αφιξη
      current_state = 3;
      ...
      if random_number < threshold_2_first #αν εχω αφιξη και απόρριψη
        arrivals(4) = arrivals(4) + 1;
        total_arrivals = total_arrivals + 1;
      elseif random_number < threshold_2_second  #αν εχω αναχωρηση με ρυθμο m1
        current_state = 2;
      else 	#αν εχω αναχωρηση με ρυθμο m2
        current_state = 1;
      endif
   endif
